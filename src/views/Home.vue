  ...
  <div class="min-h-screen bg-background">
    ...
    <div class="flex">
      ...
      >
        <div class="p-4">
          <div class="space-y-1">
            <router-link to="/" class="w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md hover:bg-secondary" :class="$route.path === '/' ? 'bg-primary/10 text-primary' : 'text-muted-foreground'">
